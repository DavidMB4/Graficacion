...
def draw_window(face):
    ...
    if face == "front":
        ...
        glVertex3f(-0.5, 0.3, 1.01)  # Ligeramente fuera para evitar conflictos visuales
        glVertex3f(0.5, 0.3, 1.01)
        glVertex3f(0.5, 0.8, 1.01)
        glVertex3f(-0.5, 0.8, 1.01)

    elif face == "back":
        # Ventana en la cara trasera
        glVertex3f(-0.5, 0.3, -1.01)
        glVertex3f(0.5, 0.3, -1.01)
        glVertex3f(0.5, 0.8, -1.01)
        glVertex3f(-0.5, 0.8, -1.01)
        ...
        glVertex3f(-1.01, 0.3, -0.5)
        glVertex3f(-1.01, 0.3, 0.5)
        glVertex3f(-1.01, 0.8, 0.5)
        glVertex3f(-1.01, 0.8, -0.5)

    elif face == "right":
        # Ventana en la cara derecha
        glVertex3f(1.01, 0.3, -0.5)
        glVertex3f(1.01, 0.3, 0.5)
        glVertex3f(1.01, 0.8, 0.5)
        glVertex3f(1.01, 0.8, -0.5)
...
def draw_house():
    ...
    # Dibujar ventanas en las cuatro caras
    draw_window("front")
    draw_window("back")
    draw_window("left")
    draw_window("right")
...
def draw_scene():
    ...
    gluLookAt(11, 8, 16,  # Posición de la cámara
